...
public class ContactAndLocationFragment extends Fragment {
    ...
    public static void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
         ...
         ////   mMap = ((SupportMapFragment) HomeClass.fragmentManager.findFragmentById(R.id.ContactAndLocationFragment)).getMap();
